# This file is executed at configure time to ensure that
# #include <nanogui/resources.h> is possible.  Previously it was executed as a
# `add_custom_command` with PRE_BUILD, but for the Ninja generator this
# typically runs as PRE_LINK, which is too late.
#
# Parent CMake is performing an include(...) on this file, and must set:
#
# BIN2C_OUTPUT_C:    the cpp file compiled into nanogui-obj
# BIN2C_OUTPUT_H:    the header file
# BIN2C_INPUT_FILES: the (CMake) list of .ttf font files to process

# Create header for C file
file(WRITE ${BIN2C_OUTPUT_C} "/* Autogenerated by bin2c */
...
file(WRITE ${BIN2C_OUTPUT_H} "/* Autogenerated by bin2c */
...
foreach(bin ${BIN2C_INPUT_FILES})
  ...
  file(APPEND ${BIN2C_OUTPUT_C} "uint8_t ${filename}[] = {${filedata}};\n\n")
  file(APPEND ${BIN2C_OUTPUT_C} "uint32_t ${filename}_size = sizeof(${filename});\n\n")
...
file(APPEND ${BIN2C_OUTPUT_C} "std::map<const std::string, const std::pair<uint8_t *, uint32_t>> __nanogui_font_map = {\n")
foreach(part ${FONT_MAP_DECL})
  file(APPEND ${BIN2C_OUTPUT_C} "${part}")
endforeach()
file(APPEND ${BIN2C_OUTPUT_C} "};\n\n")

# Create the implementation of `createFontMem` to pass-through to `nvgCreateFontMem`
file(APPEND ${BIN2C_OUTPUT_C} "int createFontMem(NVGcontext *ctx, const std::string &fontName, const std::string &fontSource) {

...
void register_button(py::module &m) {
    ...
    button
        .def(py::init<Widget *, const std::string &, int, const std::string &>(),
             ...
             py::arg("icon") = 0, py::arg("font") = std::string(""), D(Button, Button))
